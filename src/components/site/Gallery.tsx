  ...
  return (
    <section id="galeria" className="on-dark grain bg-espresso py-20 md:py-36">
      <div className="mx-auto max-w-7xl px-5 lg:px-10">
        ...
        <div className="mt-16 hidden gap-4 md:block md:columns-3 [&>*]:mb-4">
          {items.map((g, i) => (
            <motion.button
              type="button"
              key={i}
              ...
              className={cn(
                "group relative block w-full break-inside-avoid overflow-hidden rounded-sm bg-espresso-soft focus:outline-none focus-visible:ring-2 focus-visible:ring-brass",
        ...
        {open !== null && (
          ...
          >
            ...
            >
              ...
              />
              <figcaption className="mt-4 text-center text-[0.65rem] uppercase tracking-[0.24em] text-cream/60">
                {items[open]!.tag}
              </figcaption>
            </motion.figure>
          </motion.div>
